...
export const zodPlainDate = () =>
  z
    .union([z.string(), z.instanceof(Temporal.PlainDate)])
    .transform<Temporal.PlainDate>((value) => {
...
export const zodDuration = () =>
  z
    .union([z.number().nonnegative(), z.instanceof(Temporal.Duration)])
    .transform((value) => {
...
export const zodInstant = () =>
  z
    .union([z.number().nonnegative(), z.instanceof(Temporal.Instant)])
    .transform((value) => {
      if (typeof value === "number") {
